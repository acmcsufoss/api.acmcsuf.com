...
// ---- Event Converter ----
func EventDbToDomain(dbEvent dbmodels.Event) domain.Event {
	return domain.Event{
		Uuid:     dbEvent.Uuid,
...
// ---- Officer Converter ----
func OfficerDbToDomain(dbOfficer dbmodels.Officer) domain.Officer {
...
func AnnouncementDbToDomain(dbAnnouncement dbmodels.Announcement) domain.Announcement {
...
// ---- Tier Converter ----
func TierDbToDomain(dbTier dbmodels.Tier) domain.Tier {
...
// ---- Position Converter ----
func PositionDbToDomain(dbPosition dbmodels.Position) domain.Position {
